...
//! \file rapidxml_sax3.hpp This file contains rapidxml parser and DOM implementation
#include <vector>
    ...
    public:
        ...
        void parse(Ch *text, int nLen)
        {
            ...
            while (1)
            {
                ...
                skip<whitespace_pred, Flags>(text, m_textEnd);
                if (*text == 0 || text >= m_textEnd)
                    break;
    ...
    private:
        ...
        void parse_pi(Ch *&text)
        {
            ...
            if (Flags & parse_pi_nodes)
            {
                ...
                Ch *name = text;
                skip<node_name_pred, Flags>(text, m_textEnd);
                if (text == name)
        ...
        void parse_node_attributes(Ch *&text)
        {
            ...
            while (attribute_name_pred::test(*text))
            {
                ...
                skip<attribute_name_pred, Flags>(text, m_textEnd);
                if (text == name)
