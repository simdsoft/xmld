...
int com_ximpleware::iso_8859_2_chars[256];
 int com_ximpleware::iso_8859_3_chars[256];
 int com_ximpleware::iso_8859_4_chars[256];
 int com_ximpleware::iso_8859_5_chars[256];
 int com_ximpleware::iso_8859_6_chars[256];
 int com_ximpleware::iso_8859_7_chars[256];
 int com_ximpleware::iso_8859_8_chars[256];
 int com_ximpleware::iso_8859_9_chars[256];
 int com_ximpleware::iso_8859_10_chars[256];
 int com_ximpleware::iso_8859_11_chars[256];
 int com_ximpleware::iso_8859_13_chars[256];
 int com_ximpleware::iso_8859_14_chars[256];
 int com_ximpleware::iso_8859_15_chars[256];
 int com_ximpleware::windows_1250_chars[256];
 int com_ximpleware::windows_1251_chars[256];
 int com_ximpleware::windows_1252_chars[256];
 int com_ximpleware::windows_1253_chars[256];
 int com_ximpleware::windows_1254_chars[256];
 int com_ximpleware::windows_1255_chars[256];
 int com_ximpleware::windows_1256_chars[256];
 int com_ximpleware::windows_1257_chars[256];
 int com_ximpleware::windows_1258_chars[256];

 char com_ximpleware::iso_8859_2_chars_ready;
//char iso_8859_3_chars_ready;
 char com_ximpleware::iso_8859_3_chars_ready;
 char com_ximpleware::iso_8859_4_chars_ready;
 char com_ximpleware::iso_8859_5_chars_ready;
 char com_ximpleware::iso_8859_6_chars_ready;
 char com_ximpleware::iso_8859_7_chars_ready;
 char com_ximpleware::iso_8859_8_chars_ready;
 char com_ximpleware::iso_8859_9_chars_ready;
 char com_ximpleware::iso_8859_10_chars_ready;
 char com_ximpleware::iso_8859_11_chars_ready;
 char com_ximpleware::iso_8859_13_chars_ready;
 char com_ximpleware::iso_8859_14_chars_ready;
 char com_ximpleware::iso_8859_15_chars_ready;

 char com_ximpleware::windows_1250_chars_ready;
 char com_ximpleware::windows_1251_chars_ready;
 char com_ximpleware::windows_1252_chars_ready;
 char com_ximpleware::windows_1253_chars_ready;
 char com_ximpleware::windows_1254_chars_ready;
 char com_ximpleware::windows_1255_chars_ready;
 char com_ximpleware::windows_1256_chars_ready;
 char com_ximpleware::windows_1257_chars_ready;
 char com_ximpleware::windows_1258_chars_ready;
void com_ximpleware::iso_8859_2_chars_init(){
	int i;
	if (iso_8859_2_chars_ready)
		...
		iso_8859_2_chars_ready = 1;
	}
}
void com_ximpleware::iso_8859_3_chars_init(){
	int i;
	if (iso_8859_3_chars_ready)
		...
		iso_8859_3_chars_ready = 1;
	}
}
void com_ximpleware::iso_8859_4_chars_init(){
	int i;
	if (iso_8859_4_chars_ready)
		...
		iso_8859_4_chars_ready = 1;
	}
}
void com_ximpleware::iso_8859_5_chars_init(){
	int i;
	if (iso_8859_5_chars_ready)
		...
		iso_8859_5_chars_ready = 1;
	}
}
void com_ximpleware::iso_8859_6_chars_init(){
	int i;
	if (iso_8859_6_chars_ready)
		...
		iso_8859_6_chars_ready = 1;
	}
}
void com_ximpleware::iso_8859_7_chars_init(){
	int i;
	if (iso_8859_7_chars_ready)
		...
		iso_8859_7_chars_ready = 1;
	}
}
void com_ximpleware::iso_8859_8_chars_init(){
	int i;
	if (iso_8859_8_chars_ready)
		...
		iso_8859_8_chars_ready = 1;
	}
}
void com_ximpleware::iso_8859_9_chars_init(){
	int i;
	if (iso_8859_9_chars_ready)
		...
		iso_8859_9_chars_ready = 1;
	}
}
void com_ximpleware::iso_8859_10_chars_init(){
	int i;
	if (iso_8859_10_chars_ready)
		...
		iso_8859_10_chars_ready = 1;
	}
}


void com_ximpleware::iso_8859_11_chars_init(){
	int i;
	if (iso_8859_11_chars_ready)
		...
		iso_8859_11_chars_ready = 1;
	}
}


void com_ximpleware::iso_8859_13_chars_init(){
	int i;
	if (iso_8859_13_chars_ready)
		...
		iso_8859_13_chars_ready = 1;
	}
}


void com_ximpleware::iso_8859_14_chars_init(){
	int i;
	if (iso_8859_14_chars_ready)
		...
		iso_8859_14_chars_ready = 1;
	}
}


void com_ximpleware::iso_8859_15_chars_init(){
	int i;
	if (iso_8859_15_chars_ready)
		...
		iso_8859_15_chars_ready = 1;
	}
}


void com_ximpleware::windows_1250_chars_init(){
	int i;
	if (windows_1250_chars_ready)
		...
		windows_1250_chars_ready = 1;
	}
}
void com_ximpleware::windows_1251_chars_init(){
	int i;
	if (windows_1250_chars_ready)
		return;
	else{
...
void com_ximpleware::windows_1252_chars_init(){
	int i;
	if (windows_1252_chars_ready)
		...
		windows_1252_chars_ready = 1;
	}
}
void com_ximpleware::windows_1253_chars_init(){
	int i;
	if (windows_1253_chars_ready)
		...
		windows_1253_chars_ready = 1;
	}
}
void com_ximpleware::windows_1254_chars_init(){
	int i;
	if (windows_1254_chars_ready)
		...
		windows_1254_chars_ready = 1;
	}
}
void com_ximpleware::windows_1255_chars_init(){
	int i;
	if (windows_1255_chars_ready)
		...
		windows_1255_chars_ready = 1;
	}
}
void com_ximpleware::windows_1256_chars_init(){
	int i;
	if (windows_1256_chars_ready)
		...
		windows_1256_chars_ready = 1;
	}
}
void com_ximpleware::windows_1257_chars_init(){
	int i;
	if (windows_1257_chars_ready)
		...
		windows_1257_chars_ready = 1;
	}
}
void com_ximpleware::windows_1258_chars_init(){
	int i;
